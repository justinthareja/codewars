...
// return the index 3, because at the 3rd position of the array, the sum of 
// left side of the index ({1,2,3}) and the sum of the right side of the index 
// ({3,2,1}) both equal 6.

// Let's look at another one.
// You are given the array { 1, 100, 50, -51, 1, 1 }: Your function will 
// return the index 1, because at the 1st position of the array, the sum of 
// left side of the index({ 1}) and the sum of the right side of the 
...
// to the right of N.If you do not find an index that fits these rules, then you will return -1.
...
function findEvenIndex(arr) {
    ...
    arr.forEach(function(number, i, numbers) {
        if (evenIndex > -1) {
            return;
        }

        let leftSide = numbers.slice(0, i);
        let rightSide = numbers.slice(i + 1);
